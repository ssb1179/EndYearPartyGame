...
public class FourCharActivity extends AppCompatActivity {

    int stackNum = 0;
    private fourChar fc_list = new fourChar();

    private TextView main_fourChar;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.four_char_view);
...
//        newUiOptions ^= View.SYSTEM_UI_FLAG_FULLSCREEN;
        ...
        main_fourChar = findViewById(R.id.main_fourChar);
